...
html, body {
margin:0 auto;
background:url(images/Green_wall.jpg);
...
<div>
    ...
    </div><!-- akhir menu nihh,, sobb -->
    <div class="col-md-2"></div>
    <div class="col-md-10"> <!-- halaman index nih, fellass -->
        <div class="text-danger col-md-12">
            <h1 align="center" style="color: !important">Halaman Utama</h1>
        </div>
        <div class="col-md-4"></div>
            <div class="btn btn-danger col-md-4" align="center" style="margin-top:20%;">Slider bagus ga ya ?
            </div>
<!---------------------------------------------------------------------------------------------------->
