...
<div>
    <div class="header-left col-md-2" id="ronin"> <!--ini buat menu, felass -->
        ...
        <ul class="nav nav-tabs nav-stacked">   
            ...
            <li style="background:#0F0" class="active"><a href="game.php">Refreshing</a></li>
        </ul>
        <div>
...
<div class="col-md-10"> <!-- halaman index nih, fellass -->
	<div class="text-danger">
    	<h1 align="center" style="color: inherit; font:'Comic Sans MS', cursive;" >Refreshing</h1>
    </div>
    <div>
    	<!-- Masukkan Syntax gamenya disini -->
    </div>
</div>
</div>
