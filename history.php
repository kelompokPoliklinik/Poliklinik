...
<div>
    <div class="header-left col-md-2" id="ronin"> <!--ini buat menu, felass -->
        ...
        <ul class="nav nav-tabs nav-stacked">   
            ...
            <li style="background:#0F0" class="active"><a href="history.php">History</a></li>
...
<div class="col-md-10"> <!-- halaman index nih, fellass -->
	<div class="text-danger">
    	<h1 align="center" style="color: inherit; font:'Comic Sans MS', cursive;" >Pasien, Pengunjung, dan Lain-Lain</h1>
    </div>
    <div>
    	<table class="table table-striped table-hover">
        	<thead><td><strong>Name</strong></td><td><strong>0</strong></td><td><strong>1</strong></td><td><strong>2</strong></td></thead>
        	<tr><td>Nemo</td><td>Finding</td><td>Heaven</td><td>Like</td></tr>
        	<tr><td>Nemo</td><td>Finding</td><td>Heaven</td><td>Like</td></tr>
        	<tr><td>Nemo</td><td>Finding</td><td>Heaven</td><td>Like</td></tr>
        	<tr><td>Nemo</td><td>Finding</td><td>Heaven</td><td>Like</td></tr>
        </table>
