...
$lihatDataPengunjung = mysql_query("SELECT * FROM pengunjung");
	$hasilCari ='';
	$hasilCari .= '<table class="table table-hover" border="2"><tr><td>Id</td><td>Nama</td><td>Jenis</td><td>TL</td><td>Aksi</td></tr>';
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li onClick="
                            if (documentGetElementById(sa).style.display == 'none')
                            ...
                            ">
                            <a href="#"><i class="glyphicon glyphicon-user"></i> Pasien<span class=" glyphicon glyphicon-arrow-down pull-right" onClick=""></span></a>
                            <ul id="sa" class="nav nav-second-level" style="display:none;">
                        ...
                        <li>
                            <a href="#"><i class="glyphicon glyphicon-leaf"></i> Dokter<span class="glyphicon glyphicon-arrow-down pull-right"></span></a>
                            <ul class="nav nav-second-level">
...
<!-------------------------------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center"> Halaman Obat-Obatan <i class="glyphicon glyphicon-qween"></i></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
