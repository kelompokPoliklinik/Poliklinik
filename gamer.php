...
<!------------------------- Patience Page ----------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Halaman Permainan <i class="glyphicon glyphicon-scissors"></i></h1>
                </div>
            </div>
            <!-- /. end row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <marquee behavior="alternate" direction="left" loop="-2" scrolldelay="100">Game 5 vs 5</marquee>
                        </div>
                        <!-- /.panel-heading -->
