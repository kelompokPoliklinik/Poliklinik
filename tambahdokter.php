...
if (isset($_POST['submit']))
{
	...
	if($g != '-')
		$idPasien = "MHS_".+$i;
	$inputPasien = mysql_query("INSERT INTO `dokter`(`id_pasien`, `nama`, `nim_nip`, `tempat_lahir`, `tanggal_lahir`, `alamat`, `jenis_kelamin`, `pekerjaan`, `fakultas`, `alergi`) VALUES ('$idPasien','$a','$i','$b','$c','$d','$e','$f','$g','$h')");
	if (!$inputPasien)
...
<!-------------------------------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Halaman Dokter <i class="glyphicon glyphicon-heart"></i></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
