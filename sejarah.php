...
<!------------------------- Patience Page ----------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Halaman Riwayat <i class="glyphicon glyphicon-transfer"></i></h1>
                </div>
            </div>
            <!-- /. end row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <marquee behavior="alternate" direction="left" loop="-2" scrolldelay="100">History</marquee>
                        </div>
                        <!-- /.panel-heading -->
